...
RPC_URL="${COSMOS_TESTNET_RPC:-http://127.0.0.1:26667}"
NODE_URL="${COSMOS_TESTNET_NODE:-tcp://127.0.0.1:26667}"
QUERY_NODE="${COSMOS_TESTNET_QUERY_NODE:-https://rpc.provider-sentry-01.hub-testnet.polypore.xyz:443}"
